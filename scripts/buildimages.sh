...
echo 'building image application-onboarding-buildstage'
cd source
${CONTAINER_RUNTIME} build -f Dockerfile.buildstage -t application-onboarding-buildstage .
cd -

echo 'building image application-onboarding'
cd source
${CONTAINER_RUNTIME} build -f Dockerfile -t application-onboarding .
cd -
